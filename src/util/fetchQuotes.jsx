...
export const getQuotes = async (setQuote) => {
  await axios(CONSTANTS.API_QUOTE_OPTIONS.GET_RANDOM_QUOTES).then(
...
export const postTranslate = async (textConfiguration, setTranslate) => {
  await axios({
    ...CONSTANTS.API_TRANSLATE_OPTIONS.POST_TRANSLATE,
...
export const getQuoteEs = async (setQuoteEs) => {
  await axios(CONSTANTS.API_QUOTES_es.GET_RANDOM_QUOTE).then(
    (response) => {
...
export const getQuoteNorris = async (setNorris) => {
  await axios(CONSTANTS.API_CHUCK_NORRIS.GET_RANDOM_NORRIS).then(
    (response) => {
...
export const getMarvel = async (setMarvel) => {
  await axios(CONSTANTS.API_MARVEL.GET_RANDOM_MARVEL).then(
    (response) => {
...
export const getRandomNinja = async(setNinja) => {
  await axios(CONSTANTS.API_NINJA.GET_RANDOM_NINJA).then(
    (response) => {
...
export const getRandomTrump = async(setTrump) => {
  await axios(CONSTANTS.API_TRUMP.GET_RANDOM_TRUMP).then(
    (response) => setTrump(getJsonValues(response.data.message, "Donald Trump"))
  )
}

export const getRandomAnimechan = async(setAnime) => {
  await axios(CONSTANTS.API_ANIMECHAN.GET_RANDOM_ANIMECHAN).then(
    (response) => {
...
export const getRandomBreakingBad = async(setBreakingBad) => {
  await axios(CONSTANTS.API_BREAKING_BAD.GET_RANDOM_BREAKING_BAD).then(
    (response) => 
    {
